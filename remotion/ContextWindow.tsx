...
export function ContextWindow() {
  ...
  return (
    <Stage>
      ...
      <div style={{ position: "absolute", left: 64, right: 64, top: FRAME_TOP }}>
        {/* 視窗框 */}
        <div
          style={{
            position: "relative",
        ...
        >
          <div style={{ position: "absolute", left: 0, right: 0, top: scroll, opacity: 1 - clearing }}>
            {Array.from({ length: LINES }).map((_, i) => {
              ...
              const opacity = inFrame ? 0.9 - middleFade * middleness * 0.72 : 0.1;
        ...
        <div style={{ marginTop: 18, display: "flex", justifyContent: "space-between", fontSize: 21 }}>
          <span style={{ color: T.onDarkSoft, opacity: 1 - clearing }}>↑ 超出框的部分，它讀不到</span>
          <span style={{ color: T.primary, opacity: clearing }}>換一個對話 → 全部清空</span>
        </div>
      </div>
